...
When a substantive review correction exposes a preventable mistake, use [retro](../retro/SKILL.md) to identify useful prevention. Keep review-only requests read-only and reuse existing coverage where sufficient.
